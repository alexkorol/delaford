...
export default async function sessionArc({ connect, assert }) {
  ...
  try {
    ...
    attackAfterLoot = state.combat.attack.slash;
  ...
  try {
    ...
    assert(restored.combat.attack.slash === attackAfterLoot, 'relogin rebuilds the weapon combat bonus');
